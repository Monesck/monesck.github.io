function generateQuiz(questions, quizContainer, resultsContainer, submitButton){
    ...
    function showQuestions(questions, quizContainer){
      ...
      for(var i=0; i<questions.length; i++){
        ...
        output.push(
          '<div class="question bg-white p-3"><div class="d-flex flex-row align-items-center question-title"><h3 class="text-primary">' + i + '.</h3><h5 class="mt-1 ml-2"><div class="question">' + questions[i].question + '</h5></div></div>'
          + '<div class="answers">' + answers.join('') + '<hr></div></div>'
        );
      }
